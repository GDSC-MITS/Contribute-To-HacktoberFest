// Given a 2D Array we need to find the index of the row or column which contains the largest sum of its elements and to print the index along with the sum
