    ...
    Surface(
        ...
        when (currentStep) {
            1 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.lemonimage1,
                    drawableResourceId = R.drawable.lemon_tree,
                    contentDescriptionResourceId = R.string.lemon_content_description1,
                    onImageClick = {
                        // Update to next step
                        currentStep = 2
            ...
            2 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.lemonimage2,
                    drawableResourceId = R.drawable.lemon_squeeze,
                    contentDescriptionResourceId = R.string.lemon_content_description2,
                    onImageClick = {
            ...
            3 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.lemonimage3,
                    drawableResourceId = R.drawable.lemon_drink,
                    contentDescriptionResourceId = R.string.lemon_content_description3,
                    onImageClick = {
                        // Update to next step
                        currentStep = 4
                    }
            ...
            4 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.lemonimage4,
                    drawableResourceId = R.drawable.lemon_restart,
                    contentDescriptionResourceId = R.string.lemon_content_description4,
                    onImageClick = {
